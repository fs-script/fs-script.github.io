import{_ as n,o as s,c as a,e as t}from"./app.21ff8fc5.js";const p="/images/mind.jpg",e={},o=t(`<h2 id="一、vue2" tabindex="-1"><a class="header-anchor" href="#一、vue2" aria-hidden="true">#</a> 一、Vue2</h2><h3 id="_01-使用" tabindex="-1"><a class="header-anchor" href="#_01-使用" aria-hidden="true">#</a> 01 - 使用</h3><ul><li>使用 <code>script</code> 标签引入：</li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 开发环境</span>
